...
namespace AuthRoleBased
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.AddPolicy("readonlypolicy", builder => builder.RequireRole("User", "Expert", "Anonymous"));
                options.AddPolicy("writepolicy", builder => builder.RequireRole("User", "Expert"));
